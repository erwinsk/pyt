...
# Lutron -
# Lutron -
# Dependensi yang diperlukan PySide6, pyserial
...
from PySide6.QtWidgets import (
    ...
    QVBoxLayout, QHBoxLayout, QComboBox, QFileDialog, QStyle
)
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # Mengubah style enum ke standar PySide6 (Qt6)
        self.refresh_ports_btn.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
...
if __name__ == "__main__":
    ...
    window.show()
    # Menghapus underscore pada exec_() untuk menyesuaikan dengan PySide6
    sys.exit(app.exec())