...
class SerialThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            self.status_changed.emit("Terhubung")
            self.connect_btn.emit(False)

        except Exception:
            self.status_changed.emit("Serial Error")
        ...
        self.status_changed.emit("Tidak Terhubung")
    ...
    def stop_logging(self):
        ...
        if self.file_handle:
            ...
            self.file_handle = None
            self.writer = None
        self.status_changed.emit("Terhubung - Tidak Merekam")
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.status_label = QLabel("Status: Terputus")
